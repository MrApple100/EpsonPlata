                        ...
                        try {
                            ...
                            if (!Platas.containsKey(obj.title)) {
                                ...
                                if (objectsDetectedOld.get(obj.title)!! % 15 == 0 && (objectsDetectedOld.get(obj.title)!! >= 15 )) {
                                    ...
                                    objectsAngles.get(obj.title)?.location?.right = obj.location.right * scaleFactorX
                                    objectsAngles.get(obj.title)?.location?.bottom = obj.location.bottom * scaleFactorY
                                }
                                //Считываем данные
